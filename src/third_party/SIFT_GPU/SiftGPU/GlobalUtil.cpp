...
int GlobalParam::		_texMaxDim = 8000;//7400;//3200;	//Maximum working size for SiftGPU, 3200 for packed
int	GlobalParam::		_texMaxDimGL = 8000;//7400;//4096;        //GPU texture limit
    ...
    }else
    {
	    ...
	    if(glewGetExtension("GL_ARB_texture_rectangle")==GL_TRUE)
	    {
		    ...
		    glGetIntegerv(GL_MAX_RECTANGLE_TEXTURE_SIZE_EXT, &value);
                    GlobalUtil::_texMaxDimGL = 10000;//value;
