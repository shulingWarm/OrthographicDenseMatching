...
public:
	...
	SIFTGPU_EXPORT virtual int  GetSiftMatch(
                ...
                float distmax = 0.7,//0.7,	//maximum distance of sift descriptor
                float ratiomax = 0.8,//0.8,	//maximum distance ratio
                int mutual_best_match = 0); //mutual best match or one way
