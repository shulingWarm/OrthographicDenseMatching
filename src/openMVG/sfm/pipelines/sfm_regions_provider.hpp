...
public:
  ...
  ///***********
  // Set Regions related to a provided SfM_Data View container
  virtual bool set(
//          features::SIFT_Regions regions,
//    std::unique_ptr<features::SIFT_Regions> regions_ptr,
          std::unique_ptr<features::Regions>& regions_ptr,
    const IndexT id_view)
  {
//      std::unique_ptr<features::SIFT_Regions> regions_ptr(new features::SIFT_Regions(regions));
      cache_[id_view] = std::move(regions_ptr);  //id_view is image Id
      return true;
  }
