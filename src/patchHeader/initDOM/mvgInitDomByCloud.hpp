#pragma once
#include"patchHeader/initDOM/initDomByCloud.hpp"
#include"openMVG/sfm/sfm_data.hpp"
#include"patchHeader/pointcloud/3DPointWithScore.hpp"
#include<vector>

//dom的网格
using DomGrid=openMVG::sfm::DomInfo;
//三维点云
using PointCloud=std::vector<PointWithScore>;
...
protected:
    ...
    //用一个点的数据来代替cell的数据
    virtual void replaceCellData(DomCell& cell,PointWithScore& point)
    {
    ...
    void addPointToCell(DomCell& cell,PointWithScore& point)
    {
    ...
    //在dom点云里面添加一个点
    void addPointToGrid(DomGrid& grid,PointWithScore& point)
    {
        //点的三维坐标
